...
cuatro fases lógicas, desde la concepción inicial hasta el cierre, justificando el 
...
así como una justificación de cada una de ellas. Se han definido cuatro fases principales:
...
{Resumen de fases del proyecto}
	...
	\textbf{Fase 3: Implementación, Pruebas y Depuración}&16/03/2026 a 10/05/2026\\
	\textbf{Fase 4: Cierre del Proyecto y Presentación del TFG}&11/05/2026 a 25/05/2026\\
	\end{coolTable}
...
\subsection{Fase 3: Implementación, Pruebas y Depuración}
...
establecida en la fase anterior. También se concentrará en esta etapa el trabajo de pruebas, depuración y 
ajuste de las funcionalidades ya desarrolladas, para dejar una versión estable del juego antes del cierre.
...
Se ha estimado una duración de ocho semanas para esta fase, teniendo en cuenta que la cantidad de funcionalidades
adicionales que se pueden desarrollar es potencialmente muy amplia y que se pueden presentar desafíos técnicos
durante la implementación y la validación. El alcance final de esta fase se irá adaptando en función del progreso realizado y
de las dificultades encontradas, pero se ha considerado que ocho semanas es un plazo razonable para implementar, 
comprobar y depurar una cantidad significativa de funcionalidades adicionales. Cabe destacar que parte de este periodo
coincide con la Semana Santa, festividad que puede afectar el ritmo de trabajo del equipo.

\subsection{Fase 4: Cierre del Proyecto y Presentación del TFG}

En esta fase se realizará la documentación final del proyecto, incluyendo el manual de usuario y el 
informe final. Además, se preparará la presentación del TFG y se llevará a cabo una revisión 
...
definición de objetivos, elección de herramientas, diseño de la arquitectura y preparación del plan de trabajo.

\subsection{Fase 2: Implementación del Núcleo}
En esta subsección se incluirá el desarrollo de las mecánicas base del juego, es decir, todo lo necesario 
para construir el núcleo funcional sobre el que se apoyará el resto del proyecto.

\subsection{Fase 3: Implementación, Pruebas y Depuración}
En esta subsección se recogerá la implementación de funcionalidades adicionales, junto con las pruebas, 
la depuración y los ajustes realizados para estabilizar el juego.

\subsection{Fase 4: Cierre del Proyecto y Presentación del TFG}
En esta subsección se añadirá la documentación final, la preparación de la presentación y la revisión 
final del trabajo antes de su entrega.