...
\item \textbf{Issue: Sistema de Combate -- Iteración 7.} Se refinó el sistema con ataques cargados, proyectiles más ricos en comportamiento y mejor retroalimentación visual.
\end{enumerate}
...
\item \textbf{Issue: Sistema de Enemigos -- Iteración 7.} Se reforzó la diferenciación táctica entre arquetipos, la lectura visual del ataque y la respuesta al contexto del arma utilizada.
\end{enumerate}
