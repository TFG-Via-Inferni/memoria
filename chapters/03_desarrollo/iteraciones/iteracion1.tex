...
\begin{abstract}
Esta iteración recoge la primera base jugable del proyecto. En ella se construyen los
elementos mínimos necesarios para validar la viabilidad técnica del videojuego:
generación procedural del mapa, incorporación del jugador y activación inicial de
enemigos dentro de las salas.
\end{abstract}
...
El seguimiento de esta iteración se centró en comprobar si el alcance mínimo previsto para el
arranque del proyecto podía cerrarse dentro del tiempo disponible. En ese sentido, el objetivo
principal sí se cumplió: se obtuvo una primera versión jugable con generación del mapa,
jugador controlable y encuentros básicos en salas. Sin embargo, durante la ejecución también
se comprobó que la feature de generación procedural tenía más complejidad de la prevista
inicialmente, especialmente en el tratamiento consistente de ciertas salas especiales.

Por este motivo, aunque el núcleo de la iteración quedó completado en plazo, el seguimiento
del trabajo obligó a no considerar cerrada del todo esa feature. La parte restante se
replanificó para la iteración 2, donde se completaría el ajuste de la sala secreta. Esta
decisión evitó forzar un cierre artificial de la iteración y permitió mantener un criterio de
control más realista entre alcance comprometido, tiempo disponible y grado real de acabado.
