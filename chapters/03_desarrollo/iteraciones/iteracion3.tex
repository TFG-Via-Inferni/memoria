...
El seguimiento de la tercera iteración confirmó que el alcance principal podía cumplirse dentro
del tiempo previsto, aunque no todas las funcionalidades alcanzaron el mismo grado de madurez.
La lógica de círculos sí quedó cerrada con el nivel de profundidad esperado, ya que pasó de ser
una mera progresión numérica a organizar contenido real del juego. También la dualidad quedó
 suficientemente estable como primera versión jugable.

El caso distinto fue el minimapa. Durante la iteración se comprobó que su primera versión era
válida como apoyo básico de navegación, pero no suficiente para considerarlo terminado dentro del
alcance final deseado. Su dependencia del estado real de las salas, de la cámara y de la
integración en el HUD hacía que completar todos esos ajustes en la misma iteración supusiera un
riesgo para los tiempos. Por ello, se optó por cerrar una versión funcional mínima y replanificar
su segunda parte para la iteración 6, cuando el resto de sistemas implicados ya estuvieran más
estabilizados.

\section{Resultados}
El resultado de la iteración fue un aumento claro de la profundidad estructural del
proyecto. En primer lugar, la progresión por círculos dejó de limitarse al avance entre
niveles y pasó a influir directamente en la identidad del contenido jugable. En segundo
lugar, el jugador obtuvo una mecánica diferencial de alternancia entre formas que empieza a
definir la personalidad del sistema de combate. En tercer lugar, la exploración ganó una
herramienta de orientación permanente mediante un minimapa con descubrimiento progresivo.

De forma resumida, al final de esta iteración se había conseguido:

\begin{itemize}
    \item organizar salas y enemigos en pools específicos por círculo;
    \item hacer que el círculo actual determine el contenido que se genera en la partida;
    \item introducir la dualidad de personajes como cambio entre forma de melé y forma a distancia con \textit{cooldown};
    \item mantener estado compartido entre ambas formas del jugador;
    \item mostrar un minimapa básico con visibilidad progresiva según las salas descubiertas.
\end{itemize}

Desde el punto de vista del desarrollo global, esta iteración fue especialmente relevante
porque convirtió varias ideas de diseño en sistemas con impacto directo sobre la experiencia
de juego. La progresión se volvió más significativa, el jugador ganó una mecánica propia y
la exploración pasó a estar mejor informada. En conjunto, la tercera iteración marca el
paso desde una base funcional estable hacia un sistema más rico y más cercano a la
identidad final del proyecto.
