...
En esta iteración el seguimiento permitió comprobar que el alcance previsto estaba repartido
entre una tarea de cierre técnico y dos ampliaciones funcionales nuevas. La parte heredada de
generación procedural pudo completarse dentro del tiempo de la iteración, lo que permitió dar
por cerrada esa feature en un punto que en la iteración anterior todavía no era suficientemente
estable.

Sin embargo, el control del avance también mostró que la lógica de círculos no podía darse por
finalizada todavía. La primera implementación resolvió la progresión básica entre círculos, pero
durante la iteración se vio que faltaba convertir esa progresión en un sistema real de contenido
capaz de afectar a salas y enemigos. Por ello, se decidió replanificar una segunda parte de la
feature para la iteración 3. Esta revisión del alcance fue coherente con el tiempo disponible y
evitó presentar como terminada una funcionalidad que aún necesitaba una segunda consolidación.
