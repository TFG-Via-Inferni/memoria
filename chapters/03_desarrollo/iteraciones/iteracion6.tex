...
El seguimiento de esta iteración mostró que el alcance previsto estaba bien dimensionado para el
tiempo disponible. La gestión de inventario y los objetos pudieron avanzar de forma coordinada,
ya que ambos sistemas se apoyaban mutuamente y su desarrollo conjunto evitó dejar una feature
dependiente de otra sin cierre funcional.

Además, esta iteración permitió completar la segunda parte del minimapa que había sido
replanificada desde la iteración 3. La decisión de aplazar ese refinamiento resultó adecuada,
porque en este punto ya existían más estables tanto el HUD como la lógica de salas y el
seguimiento de cámara necesario para terminarlo correctamente. Desde el punto de vista del
control, esto confirma que la replanificación anterior no respondió a un retraso desordenado,
sino a una redistribución razonable del trabajo para ajustarlo mejor al contexto técnico real.

\section{Resultados}
El resultado de la iteración fue la introducción de una base clara para la progresión por
objetos y una mejora tangible de la lectura del mapa. El jugador pasó a disponer de una
