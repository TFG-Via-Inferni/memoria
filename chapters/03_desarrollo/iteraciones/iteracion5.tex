...
combate como el sistema de enemigos tenían más recorrido del estimado inicialmente. La primera
entrega cerró una base funcional sólida, con armas diferenciadas, proyectiles y enemigos mejor
integrados, pero durante el desarrollo se vio que todavía quedaban aspectos de legibilidad,
\textit{feedback} y diferenciación táctica que no convenía forzar en la misma iteración.

Por ello, el control del alcance llevó a considerar estas dos features como sistemas resueltos
en una primera fase, pero no totalmente agotados. Su refinamiento posterior se replanificó para
la iteración 7. Esta decisión responde precisamente a una de las lecciones extraídas del
proyecto: algunas features se habían estimado inicialmente como menos complejas de lo que
realmente fueron, por lo que dividirlas entre iteraciones permitió ajustar mejor los tiempos sin
comprometer la calidad del resultado entregado.
