...
El seguimiento de esta iteración muestra con claridad una desviación entre el alcance previsto y
el trabajo realmente completado hasta el momento. La planificación inicial contemplaba cerrar los
flujos de victoria, derrota y la segunda revisión visual de sprites, pero el control del avance
indica que ese cierre todavía no se ha producido y que solo se ha integrado un primer ajuste
técnico sobre la progresión mediante la llave de círculo.

Precisamente por eso, en esta iteración el seguimiento y control adquieren especial importancia:
permiten dejar constancia de que el alcance comprometido era mayor que el tiempo efectivamente
consumido hasta ahora ha permitido cerrar. En lugar de presentar estas features como terminadas,
se ha optado por documentar el estado real, distinguir entre trabajo implementado y trabajo
pendiente, y asumir la necesidad de replanificar el cierre final en función del tiempo restante.
Este criterio mantiene la trazabilidad del proyecto y evita sobrevalorar el grado real de avance.
