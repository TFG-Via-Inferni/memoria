...
de una interfaz abstracta separada de la propia sala.
...
colisionador y su vínculo con el ítem mostrado. Con ello, la tienda queda integrada no solo
como sala diferenciada, sino como un espacio funcional de intercambio dentro de la partida.
...
detectar ajustes necesarios en compras, soportes, muros rompibles, recuperación de alma y
presentación de recompensas, mejorando su coherencia espacial y funcional dentro del
recorrido.
...
\begin{table}[!htbp]
    ...
    \midrule
    Sala Tienda & \begin{minipage}[t]{\linewidth}\begin{enumerate}\item Generar partidas hasta localizar la tienda. \item Entrar, comprobar los soportes de objetos e intentar comprar usando alma mediante la tecla de interacción. \item Verificar que aparece como sala terminal diferenciada, que conserva puertas y muros coherentes, que descuenta el recurso correctamente y que entrega el objeto comprado sin romper el flujo de la partida.\end{enumerate}\end{minipage} \\
    \midrule
