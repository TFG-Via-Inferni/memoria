...
iteración, el refinamiento de combate y enemigos alcanzó un grado de cierre mayor, mientras
que las salas especiales quedaron resueltas a nivel estructural y visual, pero con remates
funcionales que pasaron a la iteración siguiente.
...
Su aporte principal en esta iteración consiste en quedar integrada dentro del reparto de
salas terminales, contar con tipo de sala diferenciado y poder representarse
...
acabado funcional completo quedó pendiente para la iteración siguiente.
