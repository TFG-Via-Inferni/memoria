...
estructura en torno a tres funcionalidades: la gestión de inventario, el sistema de objetos
...
\begin{figure}[H]
\begin{center}
% \missingfigure{Sustituir por captura representativa de Sistema de Objetos en la iteración 6}
\includegraphics[width=.9\textwidth]{figures/resultados/iteracion6/17_objetos.png}
\caption{Resultado visual de la feature Sistema de Objetos en la iteración 6}
...
\begin{figure}[H]
\begin{center}
% \missingfigure{Sustituir por captura representativa de Minimapa II en la iteración 6}
\includegraphics[width=.9\textwidth]{figures/resultados/iteracion6/18_minimap_II.png}
\caption{Resultado visual de la feature Minimapa II en la iteración 6}
...
\subsection{Diseño de Gestión de Inventario}
...
\subsection{Implementación de Gestión de Inventario}
...
el tiempo disponible. La gestión de inventario y los objetos pudieron avanzar de forma
