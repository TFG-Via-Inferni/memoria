...
\begin{figure}[!htbp]
\begin{center}
\includegraphics[width=.7\textwidth]{figures/resultados/iteracion5/14_sistema_combate.png}
...
\begin{figure}[!htbp]
\begin{center}
\includegraphics[width=.7\textwidth]{figures/resultados/iteracion5/15_sistema_enemigos.png}
...
La Figura~\ref{fig:uml-resultado-iteracion5} resume el diagrama UML de resultado de la iteración 5.
