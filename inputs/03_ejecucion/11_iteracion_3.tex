...
combate complementarias: Dante, orientado al cuerpo a cuerpo, y Virgilio, orientado al
combate a distancia. Su comportamiento real no consistía en duplicar personajes
independientes, sino en permitir que el mismo jugador alterne entre dos estados con
identidad visual propia, manteniendo estadísticas compartidas y sujeto a un tiempo de
reutilización para evitar cambios instantáneos sin coste.

La feature integra, por tanto, cuatro piezas: la representación de la forma actual, la
lógica de intercambio con \textit{cooldown}, la persistencia del estado compartido entre
ambas variantes y la selección entre tres armas distintas para cada personaje. En esa
distribución, Dante queda definido como una forma puramente de melé, mientras que Virgilio
queda asociado a armas de rango. Las estadísticas compartidas entre ambas formas son vida,
daño, probabilidad de esquiva, probabilidad de crítico y velocidad de movimiento. Con ello
se consigue que la dualidad deje de ser una idea de diseño y pase a actuar como una mecánica
concreta de juego sobre la que podrán apoyarse futuras habilidades, sistemas de combate y
decisiones tácticas.
...
Sobre esa base se definieron tres principios. El primero, que ambas formas debían compartir
el estado fundamental del personaje, especialmente vida, daño, probabilidad de esquiva,
probabilidad de crítico y velocidad de movimiento. El segundo, que el intercambio debía
tener una restricción temporal, de modo que el cambio no se convierta en una acción sin
coste ni ritmo. El tercero, que cada personaje debía disponer de su propio conjunto de tres
armas seleccionables, reforzando la identidad de Dante como forma de melé y de Virgilio como
forma de rango. También se decidió dar a cada forma una representación visual diferenciada
para que el cambio fuera legible de inmediato dentro de la partida.
...
contraria. Paralelamente, el jugador mantiene estadísticas compartidas, como vida, daño,
probabilidad de esquiva, probabilidad de crítico y velocidad de movimiento, de modo que el
cambio de forma altera la representación y el estado táctico, pero no rompe la continuidad
del personaje.

Sobre esta misma base, \texttt{PlayerStats} pasó a gestionar la selección de arma activa para
cada personaje, habilitando tres armas diferenciadas por forma. En la práctica, esto permite
que Dante opere siempre dentro del espacio de combate cuerpo a cuerpo y que Virgilio lo haga
desde la distancia, sin convertir el cambio de personaje en una mera variación cosmética.
...
\begin{table}[!htbp]
    ...
    \midrule
    Dualidad de Personajes & \begin{minipage}[t]{\linewidth}\begin{enumerate}\item Iniciar la partida con el jugador en su forma inicial y probar la selección de sus tres armas disponibles. \item Ejecutar el cambio de forma y repetirlo antes y después del tiempo de reutilización, comprobando también la selección de armas en la segunda forma. \item Verificar que cambia la representación visual, que Dante mantiene un enfoque puramente de melé, que Virgilio actúa a distancia, que las estadísticas compartidas se conservan y que el \textit{cooldown} impide alternancias inmediatas.\end{enumerate}\end{minipage} \\
    \midrule
...
Las pruebas realizadas, centradas en recorrer círculos, alternar personajes, seleccionar sus
armas y consultar el minimapa, mostraron que dualidad y progresión ofrecían el comportamiento
esperado, pero también evidenciaron que el minimapa todavía debía mejorar en representación,
integración con la cámara y encaje con el resto de la interfaz. Esa incidencia no llegó a
convertirse en un bloqueo, pero sí confirmó un riesgo importante: algunos sistemas de
interfaz dependían de una base previa más madura para cerrarse con calidad real. Por ello,
se optó por aceptar el minimapa como incremento funcional mínimo y reservar una segunda
iteración de mejora en lugar de forzar un cierre artificial.
