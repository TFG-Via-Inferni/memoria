...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=.9\textwidth]{figures/resultados/iteracion3/07_logica_circulos_II.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=.9\textwidth]{figures/resultados/iteracion3/08_dualidad_personajes.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=.9\textwidth]{figures/resultados/iteracion3/09_minimapa.png}
\caption{Resultado de la feature Minimapa en la iteración 3}
\label{fig:iteracion3-feature-minimap}
\end{center}
\end{figure}

La Figura~\ref{fig:uml-resultado-iteracion3} recoge el diagrama UML de resultado de la iteración 3.
