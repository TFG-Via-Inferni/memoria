...
para arrancar el proyecto podía completarse dentro del tiempo disponible. En términos
funcionales, el objetivo principal sí se alcanzó: se obtuvo una primera versión jugable con
generación del mapa, jugador controlable y encuentros básicos en salas. Esto permitió validar
que la dirección técnica elegida era viable y que el proyecto podía apoyarse ya en un bucle
de juego verificable.

Desde el punto de vista temporal, la planificación fue bastante ajustada. Frente a las 50:00
horas previstas, la iteración consumió 50:17 horas reales, por lo que la desviación fue
mínima. Aun así, el seguimiento del trabajo permitió detectar que algunas partes de la
generación procedural tenían más complejidad de la estimada inicialmente, especialmente en el
tratamiento coherente de ciertas salas especiales.

Por ello, aunque el alcance esencial de la iteración quedó cumplido, no resultaba conveniente
dar por completamente cerrada toda la feature de generación procedural. La parte que todavía
requería ajuste se replanificó para la iteración 2. Esta decisión permitió mantener una
relación realista entre alcance, tiempo y grado de acabado, evitando cerrar artificialmente
una funcionalidad que aún necesitaba consolidación.

El resumen de horas de la iteración puede consultarse en la Tabla~\ref{tab:iteracion1-horas}.
