...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=.9\textwidth]{figures/resultados/iteracion1/01_generacion_procedural.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=.9\textwidth]{figures/resultados/iteracion1/02_anadir_jugador.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=.9\textwidth]{figures/resultados/iteracion1/03_anadir_enemigo.png}
\caption{Resultado de la feature Enemigos en la iteración 1}
\label{fig:iteracion1-feature-enemigos}
\end{center}
\end{figure}

La Figura~\ref{fig:uml-resultado-iteracion1} recoge el diagrama UML de resultado de la iteración.
