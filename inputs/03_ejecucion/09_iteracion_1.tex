...
\subsection{Diseño de Generación Procedural I}
...
\subsection{Diseño de Añadir Jugador}
...
\subsection{Diseño de Añadir Enemigo}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=.9\textwidth]{figures/resultados/iteracion1/01_generacion_procedural_I.png}
\caption{Resultado visual de la feature Generación Procedural I en la iteración 1}
\label{fig:iteracion1-feature-generacion}
\end{center}
\end{figure}

\subsection{Implementación de Añadir Jugador}
...
\subsection{Implementación de Añadir Enemigo}
...
\caption{Resultado visual de la feature Añadir Enemigo en la iteración 1}
