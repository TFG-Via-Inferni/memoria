...
\subsection{Diseño de Lógica de Círculos I}
...
\caption{Resultado visual de la feature Generación Procedural II en la iteración 2}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=.9\textwidth]{figures/resultados/iteracion2/05_logica_circulos_I.png}
\caption{Resultado visual de la feature Lógica de Círculos I en la iteración 2}
...
\caption{Resultado visual de la feature Cámara del Jugador en la iteración 2}
