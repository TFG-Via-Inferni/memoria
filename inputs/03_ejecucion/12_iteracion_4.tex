...
interfaz. A partir de ellas se corrigieron aspectos del menú de pausa y varios desajustes del
HUD, mejorando tanto la estabilidad de los flujos de menú como la lectura de la información
durante la partida.
...
\begin{table}[!htbp]
    ...
    \midrule
    Head-Up Display & \begin{minipage}[t]{\linewidth}\begin{enumerate}\item Iniciar una partida y recorrer varias salas. \item Observar la información visible del HUD. \item Verificar que los elementos son legibles, mantienen una proporción adecuada y no invaden en exceso el área jugable.\end{enumerate}\end{minipage} \\
    \midrule
...
de forma estable, sino que también permitieron detectar incidencias concretas de interacción y
presentación. Estas incidencias se resolvieron dentro de la propia iteración, lo que evitó
arrastrar deuda visible y redujo el riesgo de que la capa de interfaz quedara cerrada solo en
apariencia. En este sentido, no fue necesario dividir ni posponer funcionalidades: los cambios
aceptados permanecieron dentro del alcance previsto y la separación entre menú de pausa y menú
principal siguió respondiendo a criterios de trazabilidad y responsabilidad funcional.
