...
\item \textbf{Menú Pausa.} Esta funcionalidad incorporó un flujo de interrupción controlada
...
\begin{figure}[H]
\begin{center}
\missingfigure{Sustituir por captura representativa del Menú Pausa en la iteración 4}
% \includegraphics[width=.9\textwidth]{figures/iteracion4_menu_pausa.png}
\caption{Resultado visual de la feature Menú Pausa en la iteración 4}
...
\begin{figure}[H]
\begin{center}
\missingfigure{Sustituir por captura representativa del Menú Principal en la iteración 4}
% \includegraphics[width=.9\textwidth]{figures/iteracion4_menu_principal.png}
\caption{Resultado visual de la feature Menú Principal en la iteración 4}
...
\begin{figure}[H]
\begin{center}
\missingfigure{Sustituir por captura representativa de Actualizar Sprites en la iteración 4}
% \includegraphics[width=.9\textwidth]{figures/iteracion4_actualizar_sprites.png}
\caption{Resultado visual de la feature Actualizar Sprites en la iteración 4}
...
\subsection{Diseño de Menú Pausa}
...
\subsection{Implementación de Menú Pausa}
