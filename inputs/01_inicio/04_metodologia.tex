...
asumible y velocidad de prototipado. A ello se añadió un factor práctico relevante: dentro
del tiempo disponible para el TFG interesaba apoyarse en una tecnología con abundantes
recursos de aprendizaje, ejemplos y material de apoyo, de modo que el esfuerzo de entrada no
desplazara el trabajo principal de diseño e implementación del videojuego.
...
ramas de trabajo y vinculación directa entre desarrollo y documentación del proceso. Desde
esa perspectiva, GitHub resultaba más apropiado que Unity Version Control para sostener un
proyecto académico en el que no solo importaba almacenar versiones, sino también justificar
decisiones y reconstruir con claridad la evolución del trabajo.
...
reducido y ya conocida por ambos integrantes del proyecto. Esto permitió llevar el
recuento de horas sin introducir una sobrecarga de gestión innecesaria ni obligar al
equipo a adaptarse a un flujo nuevo durante el desarrollo del TFG.
