...
tomando como referencia el marco PMBOK y adaptándolo a la escala de un Trabajo de Fin de
Grado desarrollado por dos estudiantes de Ingeniería Informática. El propósito del capítulo
es establecer el marco de dirección que integra los planes subsidiarios, las líneas base,
los mecanismos de control y los criterios de cierre del proyecto \cite{pmbok2021}.
\end{abstract}
...
El proyecto toma como referencia las áreas de conocimiento de PMBOK, aunque las adapta a un
equipo reducido y a un entorno académico. Se desarrollan como planes subsidiarios aquellas
áreas que tienen impacto directo en la ejecución del TFG: alcance, cronograma,
...
capítulo de adaptaciones y excepciones.
...
construcción por funcionalidad. La aplicación concreta de estos pasos al alcance y al
cronograma se desarrolla en los planes de gestión correspondientes.
...
equipo, trazabilidad y facilidad de integración con la memoria.

Unity se utiliza como motor de desarrollo por su capacidad para soportar un videojuego 2D de
tipo \textit{roguelike}, con generación procedural, gestión de escenas, interfaz, combate y
prototipado rápido \cite{unityLearnGettingStarted}. Git y GitHub se emplean para el control
de versiones, la revisión de cambios, la gestión de incidencias y la trazabilidad del
trabajo \cite{githubIssuesProjects}. GitHub Projects proporciona el tablero Kanban del
proyecto. Discord se utiliza como canal principal de comunicación operativa. Clockify
registra la dedicación temporal real de cada integrante \cite{clockifyOfficial}. La memoria
se mantiene en LaTeX por su adecuación a un documento técnico extenso, modular y con
referencias cruzadas \cite{latexProject}.
