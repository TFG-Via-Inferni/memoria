...
adaptando el enfoque del PMBOK a la escala de un TFG de desarrollo de videojuegos. Con
ello se abre la parte de planificación de la memoria, que no solo fija fechas, sino que
organiza el alcance, la comunicación, la calidad, los riesgos y los costes dentro de un
marco coherente para un equipo reducido \cite{pmbok2021}.
\end{abstract}

\section{Plan de gestión del alcance}
El alcance se gestiona a partir del \textit{Feature List} definido en Feature Driven
Development (FDD) \cite{palmer2002fdd}. Cada funcionalidad incluida en el proyecto debe satisfacer un criterio
...
planificación inicial. En total, el proyecto requiere una dedicación planificada de
600 horas de trabajo entre los dos integrantes del equipo, lo que equivale a 300 horas
por persona dentro del marco temporal definido para este TFG.
...
Para complementar la descripción del cronograma, se fija una distribución de horas
planificadas por fase. La Fase 2 se descompone además en ocho iteraciones con una
asignación homogénea de 50 horas por iteración.
...
\begin{itemize}
    ...
    \item \textbf{GitHub:} Centraliza toda la trazabilidad formal del proyecto \cite{githubIssuesProjects}. Las
