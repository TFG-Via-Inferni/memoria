...
habituales de implementación y aprovechar funcionalidades propias del entorno de Unity \cite{unityLearnGettingStarted,unityScriptableObject}.
...
Entre los materiales de apoyo más relevantes utilizados durante el aprendizaje del motor y
la validación de enfoques de implementación se encuentran tutoriales centrados en sistemas
de inventario \cite{rumpledcodeInventory}, generación procedural de mapas con inspiración
roguelike y estructura tipo \textit{Binding of Isaac} \cite{garnetBindingMap,luiscanaryProcgen},
y reflexión práctica sobre diseño de combate y \textit{game feel} \cite{gameendeavorCombatFun}.
Estas referencias no se incorporaron como soluciones cerradas, sino como apoyo para
comprender alternativas de diseño, terminología del ecosistema y patrones de trabajo
habituales en Unity.
