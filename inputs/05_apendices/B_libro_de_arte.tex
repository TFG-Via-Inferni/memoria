...
\begin{abstract}
Este apéndice recoge una selección de los recursos gráficos desarrollados para
\textit{Via Inferni}. Las imágenes incluidas corresponden a sprites, objetos, armas,
enemigos, elementos de escenario y material visual utilizado para definir la identidad
del videojuego.
\end{abstract}
