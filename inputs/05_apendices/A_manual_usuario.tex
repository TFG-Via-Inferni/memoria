...
\begin{quotation}[Designer]{Shigeru Miyamoto (1952--)}
A delayed game is eventually good, but a rushed game is forever bad.
\end{quotation}

\begin{abstract}
Este capítulo describe el uso de \textit{Via Inferni} desde la perspectiva del jugador.
Recoge la navegación por menús, los controles principales, la interacción con los sistemas
jugables y las opciones adicionales disponibles al iniciar la partida en modo de desarrollo.
\end{abstract}
...
\begin{itemize}
    ...
    \item \textbf{\texttt{Ctrl}:} si el jugador no está a vida completa y dispone de almas suficientes, consume almas para recuperar vida.
